...
public class OrderRepository extends RepositoryBase {
	private String FIND_BY_ID = "select * from user_order where id=%s";
	private String FIND_ALL_BY_USER_ID = "select * from user_order where user_id=%s";
	private String FIND_LAST_BY_USER_ID = "select * from user_order where user_id=%s ORDER BY id DESC LIMIT 1";
	
	private String ADD_ORDER = "insert into user_order (user_id, delivery_cost, order_date) values (?,?,?)";
